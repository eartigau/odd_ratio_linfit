...
%
% Reference: Artigau et al. (2021), AJ, 162, 144
% =============================================================================
...
% \citep{Artigau2021}, which is robust to outliers. This approach models each
...
We employed the odd ratio mixture model method \citep{Artigau2021} for robust
...
adopted $f_0 = 2 \times 10^{-4}$ following \citet{Artigau2021}.
...
points to be partially down-weighted rather than completely rejected, and
maintains proper error propagation throughout.

The method is implemented in the \texttt{odd\_ratio\_linfit} Python package\footnote{%
...
% model introduced by \citet{Artigau2021}. This approach treats outlier
...
% \end{equation}
%
% Following \citet{Artigau2021}, we adopt $f_0 = 2 \times 10^{-4}$. This value
